...
public class labelImage extends JFrame implements Runnable, ActionListener {
	...
	public void init() {
		...
		image1 = new ImageIcon("/Users/minjoo/Desktop/eclipse-workspace/Carcass/YELLOW.png"); // 이미지 경로
	...
	public static void main(String[] args){
		...
		labelImage exam = new labelImage();
