...
public class Frame extends JFrame implements MouseListener{
   ...
   private Timer keepGoing; 
   private Timer modeCheck ;
   ...
   public Frame() {
      ...
      modeCheck = new Timer(1000, new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            ...
            if(whiteCheck) { // white stone goes twice            
               
               
               if(blackCheck) { // black stone goes t
                  System.out.println("!!!!!");
                  blackCount = 1;
                  keepGoing.stop();
               }else {
      ...
      keepGoing = new Timer(2000, new ActionListener() {

         @Override
         public void actionPerformed(ActionEvent e) {
            // TODO Auto-generated method stub
            blackPoint.x = ((int) (Math.random() * (18)+0)) * 37;
            blackPoint.y = ((int) (Math.random() * (18)+0)) * 37;
            setBlackRock();
            blackPoint.x = ((int) (Math.random() * (18)+0)) * 37;
            blackPoint.y = ((int) (Math.random() * (18)+0)) * 37;
            setBlackRock();
      ...
      startButton.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            ...
            if(gameStart) {
               ...
               if(gameStart) {
                  if(mode == 1) {
                     blackPoint.x = ((int) Math.random() * (11 - 9) + 9)* 37;
                     blackPoint.y = ((int) Math.random() * (11 - 9) + 9) * 37;
                  }
               }
//               if(firstCheck) {
//                  Main.setFinishCheck(true);
...
//      drew.setBorderPainted(false);
      ...
      execute = new Timer(1000, new ActionListener() {
...
//            System.out.println(count + "1");
   ...
   public void setBlackRock() {
      
//      blackCheck = false;
      first:
      for(int i = 0 ; i < selectedPoint.length; i++) { // 9 ~ 11  위치에 랜덤 
         for(int j = 0 ; j < selectedPoint[i].length; j++) {
            if(i >= 9 && i <= 11 && j >= 9 && j <= 11) {
               if(selectedPoint[i][j] != 3 && selectedPoint[i][j] != 0) {
                  blackPoint.x = j * 37;
                  blackPoint.y = i * 37;
                  break first;
               }
...
//      
      ...
      for(int i = 0 ; i < pointList.size() ; i++) {
         if(pointList.get(i).x == blackPoint.x && pointList.get(i).y == blackPoint.y) {
            ...
            System.out.println(blackPoint.x + " " + blackPoint.y + " " + pointList.get(i).x + " " + pointList.get(i).y);
            break;
         }
      } //같은 지점에 놓지 않도록 
//      paintComponent(g);
//      System.out.println(blackPoint.x + " " + blackPoint.y);
      ...
      System.out.println(blackCount + " " + check);
      
      if(check) { // 같은 지점이 아니라면 
         ...
         if(!firstCheck) { //한번 만 실행 
            ...
            pointList.add(blackPoint);
            firstCheck = true;
         }else if(firstCheck && blackCount == 2) { // 카운트가 두 번 되면 
