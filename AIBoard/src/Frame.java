...
//                        }
                        if(firstCheckFour) {
                           AIRobot.mouseMove( temp1.x * 37 + 37 * 4, temp1.y * 37 + 37 * 3);
                           AIRobot.mousePress(InputEvent.BUTTON1_DOWN_MASK);
                           AIRobot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
                           
                           AIRobot.mouseMove( temp2.x * 37 + 37 * 4, temp2.y * 37 +37 * 3);
                           AIRobot.mousePress(InputEvent.BUTTON1_DOWN_MASK);
                           AIRobot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
...
//	                     System.out.println(blackSearch.size());
	               ...
	               }else if(j-1 >= 0 && selectedPoint[i][j-1] == 2 || j-1 >= 0 && selectedPoint[i][j-1] == 3) {
	                  for(int z = j ; z < j+5 ; z++) {
	                     if(selectedPoint[i][z] == 1) {
	                        count++;
	                     }else {
...
//	                     blackSearch.add(t2);
	                     ...
	                     for(int z = t2.y -2;  z < t2.y + 3 ; z++) {
	                        for(int zi = t2.x -2; zi < t2.x + 3 ; zi++ ) {
	                           if(t2.y-2 >=0 && t2.x-2>=0 && t2.y-2 <19 && t2.x-2 < 19 && min > weightGraph[z][zi]) {
	                              t1.x = zi;
	                              t1.y = z;
	                              min = weightGraph[z][zi];
	                           }
...
//	                     blackSearch.add(t2);
	      ...
	      for(int i= 0 ;i < selectedPoint.length ; i++) {
	         ArrayList<Point> zeroIndex = new ArrayList<Point>();
	         for(int j = 0; j < selectedPoint[i].length; j++) {
	            Point fir1 = new Point(-1,-1);
	            Point fir2 = new Point(-1,-1);
	            if(selectedPoint[i][j] == 1) {
	               if(i-1 >=0 && j-1 >= 0 && selectedPoint[i-1][j-1] == 0) {
	                  fir1.x = j-1;
	                  fir1.y = i-1;
	                  int count = 0;
	                  for(int z = j ; i+z < 19 && j+z < 19 && z < j + 5 ; j++) {
	                     if(selectedPoint[i+z][j+z] == 1) {
	                        count++;
	                     }else {
	                        if(selectedPoint[i+z][j+z] == 2  || selectedPoint[i+z][j+z] == 3) {
	                           break;
	                        }else if(selectedPoint[i+z][j+z] == 0){
	                           fir2.x = j+z;
	                           fir2.y = i+z;
	                  ...
	                  if(fir2.x != -1 && fir2.y != -1 && count == 4) {
	                     DefensePoint1 = fir1;
	                     DefensePoint2 = fir2;
	                     check = true;
	                     return check ;
	                  }else if(fir2.x != -1 && fir2.y != -1 && count == 5) {
	                     DefensePoint1 = fir1;
	                     DefensePoint2 = fir2;
	                     check = true;
	                     return check;
	                  }else if(fir2.x == -1 && fir2.y == -1 && count == 4) {
	                     DefensePoint2 = fir2;
	                     int min = 999999;
	                     for(int z = fir2.y -2;  z < fir2.y + 3 ; z++) {
	                        for(int zi = fir2.x -2; zi < fir2.x + 3 ; zi++ ) {
	                           if(fir2.y-2 >=0 && fir2.x-2>=0 && min > weightGraph[z][zi]) {
	                              fir1.x = zi;
	                              fir1.y = z;
	                              min = weightGraph[z][zi];
	                           }
	               ...
	               }else if(i-1 >=0 && j-1 >= 0 && selectedPoint[i-1][j-1] == 2 ||
	                     i-1 >=0 && j-1 >= 0 && selectedPoint[i-1][j-1] == 3){
	                  for(int z = j ; i+z < 19 && j+z < 19 && z < j + 5; j++) {
	                     if(selectedPoint[i+z][j+z] == 1) {
	                        count++;
	                     }else {
	                  ...
	                  if(fir2.x != -1 && fir2.y != -1 ) {
	                     int min = 999999;
	                     for(int z = fir2.y -2;  z < fir2.y + 3 ; z++) {
	                        for(int zi = fir2.x -2; zi < fir2.x + 3 ; zi++ ) {
	                           if( z >=0 && zi >=0 && z < 19 && zi < 19 &&min > weightGraph[z][zi]) {
	                              fir1.x = zi;
	                              fir1.y = z;
	                              min = weightGraph[z][zi];
	                           }
